...
[![Build Status](https://travis-ci.org/allenfantasy/famous-datepicker.svg?branch=master)](https://travis-ci.org/allenfantasy/famous-datepicker) [![Dependency Status](https://david-dm.org/allenfantasy/famous-datepicker.svg)](https://david-dm.org/allenfantasy/famous-datepicker) [![devDependency Status](https://david-dm.org/allenfantasy/famous-datepicker/dev-status.svg)](https://david-dm.org/allenfantasy/famous-datepicker#info=devDependencies)
...
## Release History
 * 2014-08-26   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)